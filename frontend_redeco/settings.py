"""Django settings for frontend_redeco project (minimal for local dev)."""
...
# Quick-start development settings - keep the secret key used in production secret!
...
ROOT_URLCONF = 'frontend_redeco.urls'
